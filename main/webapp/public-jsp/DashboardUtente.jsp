    		...
    		<div class="dashboard-container">
		      ...
		      <div class="dashboard">
		        ...
		        <div class="ui-row-1">
		          ...
		          <div class="search">
		          	<form action="<%= request.getContextPath() %>/GiocoCercaServlet" method="post" class="search">
		          ...
		          <div class="btn-group">
		            ...
		            <%   	Utente utente = (Utente) session.getAttribute("utenteLoggato");
                    		...
                    		%>
                    	<h6 id="username"> <%=utente.getUsername() %> </h6>
                    		<%
                        	} else {
		                %>
		                <p>User not logged</p>
		            ...
		            <ul class="dropdown-menu">
		              ...
		              <li><a class="dropdown-item" href="<%= request.getContextPath()%>/public-jsp/UtenteAggiornaEmail.jsp">Modifica email</a></li>
		               <li><a class="dropdown-item" href="<%= request.getContextPath()%>/public-jsp/UtenteEliminaByUsername.jsp">Elimina account</a></li>
