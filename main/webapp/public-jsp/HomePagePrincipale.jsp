...
<body>
	<div class="container-fluid">
	    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	        ...
	        <div class="collapse navbar-collapse" id="navbarNav">
	          <ul class="navbar-nav ms-2">
	            ...
	            <li class="nav-item">
	              <a class="nav-link" href="<%=request.getContextPath() %>/public-jsp/PaginaLogin.jsp" target="_blank">Login/Registrazione</a>
	            </li>
	          </ul>
			</div>
	    </nav>
		...
		<nav class="navbar navbar-light bg-light">
	      <div class="container-fluid">
	        <div class="navbar-nav mx-auto">
	          <a class="nav-link seconda-nav" href="#"><strong>NEGOZIO</strong></a>
	          <a class="nav-link seconda-nav" href="#"><strong>LIBRERIA</strong></a>
	          <a class="nav-link" href="#"><strong>ACCOUNT</strong></a>
	        </div>
	      </div>
	    </nav>
		<section id="introduzione">
		  <div class="row">
		    <div class="col-12">
		      <div class="image-container" style="background-image: url('<%=request.getContextPath() %>/risorse-media/img_homepage/Homepage_background.jpg')">
				<div id="central-navigation">
					<div id="contenitore-lista-carrello">
			        ...
			        <div id="barra-ricerca">
						...
						<form action="ListaGiochi" method="post">
				          ...
				          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16" id="lente-ingrandimento">
		...
		<footer>
		  <div class="footer-container">
		    ...
		    <section class="footer-copyright">
		      <p>© 2024 Steam Pezzotto Project. Progetto Steam e il logo di Steam sono usati a scopo puramente didattico.</p>
		    </section>
		  </div>
		</footer>
