			...
			<g>
				...
				<path fill="#C5C3C0" d="M293.611,32.379c0,2.864-2.146,4.649-4.609,4.649c-2.472,0-4.623-1.785-4.623-4.649
                    ...
                    <h3>Elenco dei giochi</h3>
                     <button id="add-product-btn" class="btn btn-primary">Aggiungi Gioco</button>
                    <%
            	...
            	<div>
                <h2>Casa Editrice , <%= utente.getUsername() %></h2>
            </div>
            <%
                } else {
            %>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div id="product-<%= gioco.getId() %>" class="single-product">
                <div class="part-1">
                    ...
                    <img class="immagine-prodotto" alt="<%= gioco.getNome() %>" src="<%= request.getContextPath() + "/risorse-media/img_giochi/" + gioco.getImmagine() %>">
...
<script src="<%= request.getContextPath() %>/Js/GiochiPublisherAggiungi.js" type="text/javascript"></script>
</body>
</html>
